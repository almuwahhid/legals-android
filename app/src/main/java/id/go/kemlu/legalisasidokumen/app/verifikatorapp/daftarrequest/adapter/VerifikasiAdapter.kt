package id.go.kemlu.legalisasidokumen.app.verifikatorapp.daftarrequest.adapter
...
class VerifikasiAdapter (context: Context, list: MutableList<RequestToVerifModel>, private val onDaftarLayananAdapter: OnVerifikasiAdapter) : RecyclerView.Adapter<VerifikasiAdapter.Holder>() {
